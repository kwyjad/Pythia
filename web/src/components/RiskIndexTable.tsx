...
const EIV_TOOLTIP =
  "EIV = sum over buckets of p(bucket) × centroid(bucket). Monthly values use surge aggregation across hazards (max hazard + 10% of the remainder) and Total is the worst month across months 1–6.";
