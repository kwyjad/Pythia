<!--- DO NOT EDIT: generated by resolver/tools/generate_schemas_md.py on 2026-01-18Z -->
...
- [db.hs_hazard_tail_packs](#dbhshazardtailpacks)
...
## db.hs_hazard_tail_packs

HS hazard tail packs with hazard-scoped research follow-ups for elevated regime change.

| Name | Type | Required | Enum/Format | Description |
| --- | --- | --- | --- | --- |
| hazard_code | string | yes |  |  |
| hs_run_id | string | yes |  |  |
| iso3 | string | yes |  |  |
| created_at | datetime | no |  |  |
| grounded | boolean | no |  |  |
| grounding_debug_json | string | no |  |  |
| query | string | no |  |  |
| rc_direction | string | no |  |  |
| rc_level | integer | no |  |  |
| rc_score | number | no |  |  |
| rc_window | string | no |  |  |
| recent_signals_json | string | no |  |  |
| report_markdown | string | no |  |  |
| sources_json | string | no |  |  |
| structural_context | string | no |  |  |
