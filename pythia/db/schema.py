...
def ensure_schema(con: Optional[duckdb.DuckDBPyConnection] = None) -> None:
    ...
    try:
        ...
        _ensure_table_and_columns(
            ...
            "sibyl_runs",
            """
            CREATE TABLE IF NOT EXISTS sibyl_runs (
                sibyl_run_id TEXT,
                hs_run_id TEXT,
                as_of DATE,
                model TEXT,
                ...
                max_steps INTEGER,
                aggregation TEXT,
                run_hard_cap_usd DOUBLE,
                budget_capped BOOLEAN,
                run_cost_usd DOUBLE,
                opus_cost_usd DOUBLE,
                brave_cost_usd DOUBLE,
                n_selected INTEGER,
                n_forecast INTEGER,
                n_skipped INTEGER,
                config_json TEXT,
        ...
        _ensure_table_and_columns(
            ...
            "sibyl_forecasts",
            """
            CREATE TABLE IF NOT EXISTS sibyl_forecasts (
                sibyl_run_id TEXT,
                run_id TEXT,
                question_id TEXT,
                iso3 TEXT,
                ...
                triage_score DOUBLE,
                pooled_quantiles_json TEXT,
                trials_json TEXT,
                bucket_probs_json TEXT,
                js_divergence_vs_standard DOUBLE,
                js_divergence_inter_trial DOUBLE,
                cost_usd DOUBLE,
                opus_cost_usd DOUBLE,
                brave_cost_usd DOUBLE,
                leakage_json TEXT,
