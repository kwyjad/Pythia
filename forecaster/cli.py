...
# --- Backward-compat re-exports (pure code motion) --------------------------
# These names were moved verbatim to forecaster/month_utils.py,
# forecaster/aggregators.py and forecaster/history_loaders.py. They are
# re-imported here so `forecaster.cli.X` and `from forecaster.cli import X`
# keep working for every moved name (including the module-level mutable
# cache/lock, whose object identity is preserved).
from forecaster.month_utils import (  # noqa: F401 - backward-compat re-exports
    _add_months,
    _anchor_month_for_question,
    _coerce_date,
    _expected_months,
    _first_target_month,
    _is_calendar_month_key,
    _month_index_for_label,
    _parse_month_key,
    _parse_month_offset_key,
    _sanitize_month_series,
)
from forecaster.aggregators import (  # noqa: F401 - backward-compat re-exports
    _CALIB_WEIGHTS_CACHE,
    _CALIB_WEIGHTS_LOCK,
    _PYTHIA_CFG_LOAD,
    _calibration_weights_enabled,
    _load_calibration_weights_db,
    _load_calibration_weights_file,
    _member_weight_key,
    _pythia_db_path_from_config,
    _pythia_db_url_from_config,
    _reset_calibration_weights_cache,
)
from forecaster.history_loaders import (  # noqa: F401 - backward-compat re-exports
    COUNTRIES_CSV,
    IDMC_HZ_MAP,
    ...
    _load_country_names,
    _load_idmc_conflict_flow_history_summary,
