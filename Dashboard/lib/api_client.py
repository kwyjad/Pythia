...
def _cached_get(base_url: str, path: str, param_items: Tuple[Tuple[str, Any], ...], token: str) -> Dict[str, Any]:
    params = {k: v for k, v in param_items if v not in (None, "")}
...
def api_get(path: str, params: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    token = get_token()
    param_items: Tuple[Tuple[str, Any], ...] = tuple(sorted((params or {}).items()))
