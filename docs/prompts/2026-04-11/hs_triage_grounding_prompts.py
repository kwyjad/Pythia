...
- UN/humanitarian: OCHA ReliefWeb, OCHA situation reports, UNHCR, ICRC, humanitarian dashboards
- Specialist conflict sources: International Crisis Group, ACLED analysis, The New Humanitarian
...
- Search for headlines from: The Economist, Bloomberg, Foreign Policy, Foreign Affairs

RECENCY FILTER: Prefer sources from the last 60 days. Older sources acceptable for structural context and ongoing crisis background.
...
PRIORITIZE THESE SOURCES (in order of reliability):
- Food security specialists: FEWS NET, FAO GIEWS, WFP VAM, IPC, Nutrition Cluster
- Humanitarian: OCHA ReliefWeb, OCHA situation reports, UNICEF, The New Humanitarian
...
RECENCY FILTER: Prefer sources from the last 90 days. Seasonal forecast outlooks and IPC analyses up to 120 days old are acceptable.
...
PRIORITIZE THESE SOURCES (in order of reliability):
- Humanitarian: OCHA (flash updates, situation reports), IFRC, IOM DTM, ReliefWeb
...
RECENCY FILTER: Prefer sources from the last 60 days. Active flood events and aftermath reporting are most useful.
...
RECENCY FILTER: Prefer sources from the last 60 days. Seasonal temperature outlooks up to 90 days old are acceptable.
...
- Humanitarian: OCHA flash updates, IFRC emergency appeals, national disaster management agencies
...
RECENCY FILTER: For active storms, only the last 7 days matter. For seasonal outlooks and recovery status, up to 90 days is acceptable.
