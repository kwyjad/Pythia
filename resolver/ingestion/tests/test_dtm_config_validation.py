...
def test_config_country_list_ignored(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    class DiscoveryClient:
        ...
        def get_operations(self, *_: object, **__: object) -> pd.DataFrame:
            return pd.DataFrame()
...
def test_discovery_empty_failfast(
    ...
    class EmptyDiscoveryClient:
        ...
        def get_countries(self, **__: object) -> pd.DataFrame:
            return pd.DataFrame(columns=["CountryName"])

        def get_operations(self, **__: object) -> pd.DataFrame:
            return pd.DataFrame()
    ...
    assert fail_payload["reason"] == "empty_discovery"
