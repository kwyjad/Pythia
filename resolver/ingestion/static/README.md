...
- HTTP behaviour is tunable: set `IDMC_HTTP_CONNECT_TIMEOUT_S` /
  ...
  exact network failure mode.【F:scripts/ci/probe_idmc_reachability.py†L1-L214】【F:scripts/ci/summarize_connectors.py†L1378-L2071】
