...
- `iso3_master.csv` holds the canonical list of ISO3 codes used by ingestion
  ...
  `IDMC_COUNTRIES_FILE` when you need to narrow the scope for a run.【F:resolver/ingestion/utils/country_utils.py†L118-L209】【F:resolver/ingestion/idmc/cli.py†L221-L318】
