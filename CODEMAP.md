...
- [`resolver/snapshot`](resolver/snapshot): Placeholder package for the upcoming DB-first snapshot builder. The stub CLI entrypoint lives at [`resolver/cli/snapshot_from_db.py`](resolver/cli/snapshot_from_db.py).
